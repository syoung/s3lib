dojo.provide("plugins.files.FileSelector");

dojo.require("dojox.widget.RollingList");

//dojo.require("plugins.files._GroupSelectorPane");
...
dojo.declare("plugins.workflow._FileInfoPane", 
	...
	postMixInProperties: function(){
	    //////console.log("FileSelector.postMixInProperties	plugins.workflow.FileSelector.postMixInProperties()");
	...
	onItems: function()
	{
	    //////console.log("FileSelector.onItems	plugins.workflow.FileSelector.onItems()");
		// summary:
		...
		//////console.log("FileSelector.onItems     plugins.workflow.FileSelector.onItems()");
		//////console.log("FileSelector.onItems     this.store: " + this.store);
		//////console.log("FileSelector.onItems     item: " + item);
...
dojo.declare("plugins.workflow.FileSelector", dojox.widget.RollingList, {
	...
	_itemsMatch: function(/*item*/ item1, /*item*/ item2){
	    //////console.log("FileSelector._itemsMatch	plugins.workflow.FileSelector._itemsMatch(/*item*/ item1, /*item*/ item2)");
		...
		//////console.log("FileSelector._itemsMatch	Returning true");
	...
	constructor : function(args) {
	    //////console.log("FileSelector.constructor	plugins.workflow.FileSelector.constructor(args)");
	    ...
	    //////console.log("FileSelector.constructor	this.callback: " + this.callback);		
	    //////console.log("FileSelector.constructor	this.parentWidget: " + this.parentWidget);
	    //////console.log("FileSelector.constructor	this.workflowObject: " + this.workflowObject);
	...
	startup: function(){
		//////console.log("FileSelector.startup     plugins.workflow.FileSelector.startup()");
		//////console.log("FileSelector.startup     this._started: " + this._started);


		if (this._started )
		{
			//////console.log("FileSelector.startup     this._started is defined. Returning...");
			return;
		}

		//////console.log("FileSelector.startup     BEFORE this.inherited(arguments)");
		this.inherited(arguments);
		//////console.log("FileSelector.startup     AFTER this.inherited(arguments)");

		// Figure out our file separator if we don't have it yet
		var conn, child = this.getChildren()[0];

	//////console.log("FileSelector.startup child: " + child);
	...
	//////console.log("FileSelector.startup    item setSeparator     item: " + item);
	...
	//////console.log("FileSelector.startupstartup    item setSeparator      path: " + path);
	...
	_removeAfter: function(/*Widget or int*/ idx){
	    //////console.log("FileSelector._removeAfter	plugins.workflow.FileSelector._removeAfter(/*Widget or int*/ idx)");
	    //////console.log("FileSelector._removeAfter	idx: " + idx);
	...
	addChild: function(/*Widget*/ widget, /*int?*/ insertIndex){
	    //////console.log("FileSelector.addChild	plugins.workflow.FileSelector.addChild(/*Widget*/ widget, /*int?*/ insertIndex)");
		//////console.log("FileSelector.addChild	widget: " + widget);
	    //////console.log("FileSelector.addChild	insertIndex: " + insertIndex);
		...
		//////console.log("FileSelector.addChild     plugins.workflow.FileSelector.addChild()");
		//////console.log("FileSelector.addChild     widget: " + widget);
		//////console.log("FileSelector.addChild     widget.id: " + widget.id);
		//////console.log("FileSelector.addChild     insertIndex: " + insertIndex);
		...
		//////console.log("FileSelector.addChild     BEFORE this.inherited(arguments)");
		this.inherited(arguments);
		//////console.log("FileSelector.addChild     AFTER this.inherited(arguments)");
	...
	getChildItems: function(item){
	    //////console.log("FileSelector.getChildItems	plugins.workflow.FileSelector.getChildItems(item)");
	...
	{
	    ////////console.log("FileSelector._getMenuItemForItem	plugins.workflow.FileSelector._getMenuItemForItem(/*item*/ item, /* dijit._Contained */ parentPane)");
	...
	getMenuItemForItem: function(/*item*/ item, /* dijit._Contained */ parentPane, /* item[]? */ children){
	    ////////console.log("FileSelector.getMenuItemForItem	plugins.workflow.FileSelector.getMenuItemForItem(/*item*/ item, /* dijit._Contained */ parentPane, /* item[]? */ children)");
	...
	{
		//////console.log("FileSelector.XXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
	    //////console.log("FileSelector.getPaneForItem	plugins.workflow.FileSelector.getPaneForItem(/*item*/ item, /* dijit._Contained */ parentPane, /* item[]? */ children)");

		//////console.log("FileSelector.HERE");

		//if ( item )
		//{
		//////console.log("FileSelector.getPaneForItem	   item: " + item);
		//////console.log("FileSelector.getPaneForItem	   item JSON: " + dojo.toJson(item));
		//}
		...
		//if( ! item || item.children )
		{
		    ...
		    //////console.log("FileSelector.getPaneForItem	   this.callback: " + this.callback.toString());
		    ...
		    //////console.log("FileSelector.getPaneForItem	   groupDragPane: " + groupDragPane);
		}
	...
	_setPathValueAttr: function(/*string*/ path){
	    //////console.log("FileSelector._setPathValueAttr	plugins.workflow.FileSelector._setPathValueAttr(/*string*/ path)");
	...
	_getPathValueAttr: function(/*item?*/val){
	    //////console.log("FileSelector._getPathValueAttr	plugins.workflow.FileSelector._getPathValueAttr(/*item?*/val)");
