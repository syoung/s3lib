...
constructor : function(json) {
	////console.log("Plugin.constructor    plugins.core.Plugin.constructor(json)");
	////console.log("Plugin.constructor    json: " + dojo.toJson(json));

	if ( ! json.name )
	{
		////console.log("Plugin name is empty!");
		return;
	}
	this.name = json.name;
	...
	var success = this.install();
	////console.log("Plugin.constructor    this.install() success: " + success);
},

install : function () {
	// LOAD PLUGINS
	//console.log("Plugin.install    plugins.core.Plugin.install()");
	//console.log("Plugin.install    this.name: " + this.name);
