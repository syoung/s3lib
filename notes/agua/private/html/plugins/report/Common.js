...
dojo.declare( "plugins.report.Common", null,
{
	...
	saveReport : function()
	{
		console.log("Common.saveReport     plugins.report.Common.saveReport()");
		//console.log("Common.saveReport     this.url: " + this.url);
		
		// STORE JSON QUERY
		var json = this.getData();
		console.log("Common.saveReport     json: " + dojo.toJson(json));
		...
		console.log("Common.saveReport     query: " + dojo.toJson(query));
		...
		dojo.xhrPut(
			{
				...
				load: function(response, ioArgs) {
					console.log("Common.JSON Post worked.");
					return response;
				},
				error: function(response, ioArgs) {
					console.log("Common.Error with JSON Post, response: " + response + ", ioArgs: " + ioArgs);
					return response;
				}
			}
		);
