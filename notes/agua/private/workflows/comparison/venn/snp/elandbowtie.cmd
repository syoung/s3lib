...
--replicates 1-33 \
--loop parallel \
--executable /nethome/syoung/0.5/bin/apps/snp/VENN.pl \
...
--outputdir /scratch/syoung/base/pipeline/SRA/NA18507/SRP000239/sampled/200bp/chr22/venn/snp/elandbowtie \
--querylabel eland \
--targetlabel bowtie \
--binlevel 500000 \
--suffix "-%REPLICATE%.snp" \
--filename hit.bam \
--maxjobs 1000 \
--queue small \
--cluster LSF \
