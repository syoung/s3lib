...
class SGELoadBalancer(LoadBalancer):
    ...
    *** All times are in SECONDS unless otherwise specified ***
    ...
    def __init__(self, interval=60, max_nodes=5, wait_time=900,
        ...
        #log.debug("balancers.sge.__init__.__init__    self.execdport: %s" % self.execdport)
        #log.debug("balancers.sge.__init__.__init__    self.root: %s" % self.root)
        #log.debug("balancers.sge.__init__.__init__    self.cell: %s" % self.cell)
