...
dojo.declare("plugins.workflow._GroupSelectorPane",
	...
	constructor : function(args) {
	    ////console.log("_GroupSelectorPane.constructor	plugins.workflow._GroupSelectorPane.constructor(args)");
	    ...
	    ////console.log("_GroupSelectorPane.constructor	this: " + this);
	    ////console.log("_GroupSelectorPane.constructor	this.callback: " + dojo.toJson(this.callback));

	    ////console.log("_GroupSelectorPane.constructor	parentWidget: " + this.parentWidget);
	    ////console.log("_GroupSelectorPane.constructor	grandParentWidget: " + this.grandParentWidget);
	    ////console.log("_GroupSelectorPane.constructor	workflowObject: " + this.workflowObject);
	...
	{
	    //////console.log("_GroupSelectorPane.createMenu	plugins.workflow._GroupSelectorPane.createMenu(type)");
		...
		dojo.connect(mItem1, "onClick", function()
			{
			    ////console.log("_GroupSelectorPane.createMenu	 'Select' onClick");

				// GET FULL PATH OF FILE
				var item = dynamicMenu.currentTarget.item;
				var file = item.parentPath + "/" + item.path;

			    ////console.log("_GroupSelectorPane.createMenu	 item: " + dojo.toJson(item));
			    ...
			    ////console.log("_GroupSelectorPane.createMenu	 'Select' onClick DOING callback("+ file+", " + location + ")");
			    ...
			    ////console.log("_GroupSelectorPane.createMenu	 Doing selectorPane.grandParentWidget.fileManagerDialog.hide()");
				selectorPane.grandParentWidget.fileManagerDialog.hide();
	
				// DO CALLBACK	
			//    ////console.log("_GroupSelectorPane.createMenu	 Doing selectorPane.callback.callFunction(selectorPane.callback.callArguments)");
