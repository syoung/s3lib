...
dojo.declare("plugins.workflow._GroupDragPane",
		...
		dojo.connect(mItem2, "onClick", function()
			{
				...
				{
					//console.log("_GroupDragPane.createMenu Open.onClick    Agua.workflowController not defined");
				}
	...
	onItems: function()
	{
		...
		//{
		//	////console.log("plugins.project._GroupDragPane.onItems    this.items.length == 0");
		//	////console.log("plugins.project._GroupDragPane.onItems    Inserting empty item");
		//
		...
		//	//
		//	//////console.log("plugins.project._GroupDragPane.onItems    menuNode.id: " + menuNode.id);
		//	//if ( menuNode && menuNode.parentNode && menuNode.parentNode.parentNode )
		//	//{
		//	//	var grandparentNode = menuNode.parentNode.parentNode;
		//	//	//////console.log("plugins.project._GroupDragPane.emptyDir     grandparentNode: " + grandparentNode);
		//	//	//////console.log("plugins.project._GroupDragPane.emptyDir     grandparentNode.firstChild: " + grandparentNode.firstChild);
		//	//
		//	//	grandparentNode.removeChild(grandparentNode.firstChild);
		//	//	//////console.log("plugins.project._GroupDragPane.emptyDir     Finished grandparxentNode.removeChild(grandparentNode.firstChild)");
		//	//}
		//	//
		...
		if ( ! this.items.length )
		{
			//console.log("plugins.workflow._GroupDragPane.onItems    Inserting empty item");
		...
		if ( this.items.length )
		{
				...
				function(item)
			{
				...
				//if ( child.data == 'EMPTY' )
				//{
				//	//////console.log("child data is empty for item");
				//}
				...
				if(child)
				{
					...
					this._dragSource.onDropExternal =  function(source, nodes, copy){						
						...
						var doCopy = function(url, query)
						{
							...
							var fileDragHeight = groupDragPane.parentWidget.domNode.offsetHeight;
							var fileDragWidth = groupDragPane.parentWidget.domNode.offsetWidth;
							//////console.log("doCopy     fileDragTop: " + fileDragTop);
							//////console.log("doCopy     fileDragLeft: " + fileDragLeft);
								...
								dojo.fadeIn(
									{
										...
										onEnd: function (){
											...
											if ( copyCompleted )
											{
												//////console.log("copyDialog onEnd    copyCompleted");
												var box = groupDragPane._copyBox;
												//////console.log("copyDialog onEnd    box: " + box);
