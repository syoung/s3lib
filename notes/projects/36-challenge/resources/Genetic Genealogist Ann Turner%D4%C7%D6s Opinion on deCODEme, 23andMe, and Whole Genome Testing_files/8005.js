...
function main(){
var wdgt={getMappedCategory:function(_17f){
if(_17f!=null){
var res=this.categoriesMap[_17f.toLowerCase()];
if(res==null){
...
},getSearchPageUrl:function(_182,_183){
if(!_183){
_183="blended";
}
return "http://"+this.amazonURL+"/s/?url="+"search-alias="+_183+"&field-keywords="+encodeURIComponent(_182)+"&tag="+this.tag+"&link_code="+this.linkCode+"&camp="+_amzn_utils.getString(_amzn_utils.CampaignID,this.marketPlace)+"&creative="+this.creativeId()+"&_encoding=UTF-8";
},setATagParameters:function(a){
if(this.new_target_page&&this.new_target_page!="false"){
a.target="_blank";
}
},insertATag:function(node,data){
var _187=node.parentNode;
var _188=document.createElement("A");
var str=node.nodeValue;
var href;
var asin=node.getAttribute("asin");
var _18c;
if(_amzn_utils.amzn_isMSIE()&&node.getAttributeNode("search")){
_18c=node.getAttributeNode("search").value;
}else{
_18c=node.getAttribute("search");
}
var _18d=node.getAttribute("category");
if(asin!=null){
...
href=this.getSearchPageUrl(_18c,this.getMappedCategory(_18d));
}
_188.href=href;
_188.innerHTML=data;
this.setATagParameters(_188);
_187.replaceChild(_188,node);
_amzn_utils.recordImpression(amzn_wdgt.tag,this.linkCode,this.creativeId(),this.marketPlace);
amzn_wdgts_vars[this.marketPlace][this.templateId][this.instanceId].hasLoaded=true;
},internalMain:function(_18e){
_18e=_amzn_utils.escapeHTML(_18e);
this.populateCategoriesMap();
this.tag=_18e.tag;
this.serviceVersion=_18e.serviceVersion;
this.new_target_page=_18e.new_target_page;
var _18f=document.getElementsByTagName("a");
for(var i=0;i<_18f.length;i++){
var link=_18f.item(i);
...
},serviceVersion:"",tag:"",instanceId:0,templateId:"8005",linkCode:"wql",creativeId:function(){
...
this.categoriesMap["shoes"]="shoes";
