...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,rm,wmv,rtf,ppt,swf,prc,xml"
s.linkInternalFilters="javascript:,cdc,file:///,outbind,//www/,mid://,//cisat.isciii.es/mmwr/,//iier.isciii.es/mmwr/,//iier1.isciii.es/atsdr/,//cisat1.isciii.es/atsdr/,bam.gov,5aday.gov"
...
+"/'+(s.ssl?'mtrics':'mtrics')+'.cdc.gov/b/ss/'+s.un+'/1/H.6-pdv-"
