...
triggerParms["mid"] = "xgVRJAYcYNFtpp5Jkc1Jdg=="; // model instance id
triggerParms["cid"] = "oBlFEFkU5xw4gJpNlUUh1w=="; // customer id
triggerParms["lf"] = 4; // loyalty factor
triggerParms["sp"] = 5.5; // sample percentage
...
triggerParms["lfcookie"] = "ForeseeLoyalty_MID_xgVRJAYcYN";
triggerParms["ascookie"] = "ForeseeSurveyShown_xgVRJAYcYN";
triggerParms["width"] = 420; // survey width
triggerParms["height"] = 500; // survey height
triggerParms["domain"] = ".grants.gov"; // domain name
...
triggerParms["dhtmlWidth"] = 500; // welcome page width
triggerParms["dhtmlHeight"] = 380; // welcome page height
