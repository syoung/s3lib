...
function fsrPopWindow(myURL){
      var lf =(self.screen.width - triggerParms["width"])/2;
      var tp =(self.screen.height - triggerParms["height"])/2;
      ...
      var newWin = window.open(myURL, "newWin", winOptions);
