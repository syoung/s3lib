...
getStatus() { echo '{"username":"syoung","sessionId":"9999999999.9999.999","project":"Project1","workflow":"Workflow1","mode":"getStatus"}' | ./workflow.cgi; }
...
#### RUN TOPHAT
alias runt='/home/syoung/0.6/bin/apps/expression/TOPHAT.pl    arguments: --cpus 3 --distance 200 --inputfiles /nethome/syoung/agua/Project1/Workflow1/yoruba1-1.reads_1.1M.sequence.txt --label yoru\
ba --matefiles /nethome/syoung/agua/Project1/Workflow1/yoruba1-1.reads_2.1M.sequence.txt --outputdir /nethome/syoung/agua/Project1/Workflow1 --reference /nethome/syoung/agua/Project1/Workflow1/chr\
...
#### RUN WORKFLOW
alias run="echo '{\"username\":\"syoung\",\"sessionId\":\"9999999999.9999.999\",\"project\":\"Project1\",\"workflow\":\"Workflow1\",\"mode\":\"executeWorkflow\"}' | ./workflow.cgi"
alias status="echo '{\"username\":\"syoung\",\"sessionId\":\"9999999999.9999.999\",\"project\":\"Project1\",\"workflow\":\"Workflow1\",\"mode\":\"getStatus\"}' | ./workflow.cgi"
...
export PATH=~/0.6/bin/apps/utils:$PATH
...
# export SGE_ROOT=/Users/young/apps/sge
