...
cp /root/.bash_profile $HOMEDIR/syoung/notes/backup/bash/root/.bash_profile;
cp $HOMEDIR/syoung/.bash_profile $HOMEDIR/syoung/notes/backup/bash/syoung/.bash_profile;
cp /var/www/.bash_profile $HOMEDIR/syoung/notes/backup/bash/www-data/.bash_profile;
